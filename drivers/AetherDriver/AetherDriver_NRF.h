#ifndef __AETHERDIVER_NRF__
#define __AETHERDIVER_NRF__ 

#define NRF24L01_DelayMs(n)    delay_ms(n)
#define NRF24L01_Delay500Ms(n) delay_ms(n*500)
#define NRF24L01_Delay(n)      CPU_Delay(n)

...
void SCCB_Init(){
    PORT_SetPinMux(SCCB_PORT_BASE,SCCB_SCL,kPORT_MuxAsGpio);
    PORT_SetPinMux(SCCB_PORT_BASE,SCCB_SDA,kPORT_MuxAsGpio);

    gpio_init(SCCB_BASE,SCCB_SCL,OUT,LOW);
    gpio_init(SCCB_BASE,SCCB_SDA,OUT,LOW);
}

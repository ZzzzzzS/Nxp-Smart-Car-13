...
#define KEY_UP !gpio_read(GPIOE,9)
#define KEY_DOWN !gpio_read(GPIOE,6)
#define KEY_LEFT !gpio_read(GPIOE,10)
#define KEY_RIGHT !gpio_read(GPIOE,8)
#define KEY_ENTER !gpio_read(GPIOE,7)

#define BUTTON_BASE GPIOE 
#define BUTTON_PORT_BASE PORTE 

#define BUTTON_LEFT  29U
#define BUTTON_RIGHT 30U
